...
public class IntegrationTest {
    ...
    public static Stream<Arguments> getTestValues() {
        return Stream.of(
                ...
                Arguments.of(-0.69 * Math.PI, 0, 0.000001),
                Arguments.of(-0.19 * Math.PI, 0, 0.000001),
                Arguments.of(-0.55, 0, 1.0),
                Arguments.of(0, Double.NaN, 0.0),
                Arguments.of(0.5, 379.8, 1.0),
                Arguments.of(0.8, 276918d, 1.0),
                Arguments.of(1, Double.NaN, 0.0),
                Arguments.of(1.5, 3, 1.0),
                Arguments.of(4, 0.035, 0.001),
                Arguments.of(4.172, 0.000000087, 0.000000001),
                Arguments.of(4.5, 0.082, 0.001),
                Arguments.of(10, 2.316, 0.001)
        );
    }
